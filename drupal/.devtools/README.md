...
| `import` | Build the documentation from its pinned source, import it, export it through Tome, and report what changed under `content/`. `--check` fails on any change instead. |
